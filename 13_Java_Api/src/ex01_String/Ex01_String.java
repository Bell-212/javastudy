...
public class Ex01_String {
  ...
  public static void ex07() {   // 중요!!
    ...
    String firstName = name.substring(0, 3);  // tom 반환
    String lastName = name.substring(4);    // cruise 반환
  ...
  public static void ex10() {
    ...
    // contains 메소드
    // 지정된 CharSequence(String, char[] 등)가 포함되어 있으면 true, 아니면 false 반환
  ...
  public static void ex11() {
    ...
    // isBlank 메소드
    // 1. 빈 문자열이거나, 공백 문자로 구성되었다면 true, 아니면 false 반환
  ...
  public static void ex12() {
    ...
    // 출력 폭 조정
    System.out.println(String.format("%5d", number));  // 10자리 10진수로 표시, 숫자를 오른쪽 정렬 처리
    System.out.println(String.format("%-5d", number));  // 10자리 10진수로 표시, 숫자를 왼쪽 정렬 처리
    System.out.println(String.format("%05d", number));  // 10자리 10진수로 표시, 숫자를 오른쪽 정렬 처리, 빈 자리를 0으로 채움
  ...
  public static void ex15() {  // 정규식 활용
