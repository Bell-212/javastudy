...
public class MainWrapper {
 ...
 // 문제. 아래 내용을 가지는 C:/storage/product.json 파일 생성하기
     ...
     */
    // 내풀이 결과:{code=0001, price=100, name=냉장고, sales=[하이마트, 전자랜드]}{code=0002, price=200, name=에어컨, sales=[하이마트]}
    // 앞뒤에 대괄호가 누락되었다.
//    Map<String, Object> map1 = new HashMap<String, Object>();
//    List<Object> list1 = Arrays.asList("하이마트", "전자랜드");
//    map1.put("code", "0001");
//    map1.put("name", "냉장고");
//    map1.put("price", 100);
//    map1.put("sales", list1);
//    
//    Map<String, Object> map2 = new HashMap<String, Object>();
//    List<Object> list2 = Arrays.asList("하이마트");
//    map2.put("code", "0002");
//    map2.put("name", "에어컨");
//    map2.put("price", 200);
//    map2.put("sales", list2);
//
//    List<Map<String, Object>> listAll = Arrays.asList(map1, map2);
//    
//    // 출력스트림
