...
public class MainWrapper {
  ...
  public static void ex01() {
    ...
    try {
      ...
      // 파일입력스트림 생성(반드시 예외 처리가 필요, 파일이 없으면 FileNotFoundException 발생)
 ...
 // 디렉터리를 File 객체로 만들기
  ...
  public static void ex03() {
    ...
    try {
      ...
      // 버퍼입력스트림 생성(반드시 예외 처리가 필요, 파일이 없으면 FileNotFoundException 발생)
  ...
  public static void ex04() {
     ...
     * 1. Reader 클래스를 상속받는 클래스이다. (문자 입력스트림이다.)
