...
public class MainWrapper {
  ...
  public static void ex01() {
    ...
    season.add("가을");         
    season.add("겨울");         
    season.add(0, "봄");  // add 메소드로 index 0에 "봄"을 추가하면 이전 요소들이 한칸씩 뒤로 밀려난다.
    ...
    //배열 for문 적용하기 (리팩토링 : season.get 메소드가 여러 번 호출되는 문제 해결)
  ...
  public static void ex03() {
    ...
    // 요소 수정하기
    flower.set(0, "백일홍"); // index 0의 요소를 "백일홍"으로 수정
    
    // 요소 삭제하기
    flower.remove(1); // index 1의 요소를 삭제
