...
public class MainWrapper {
  ...
  public static void q3() {
    ...
    int height = 3;
    double area;
    area = width * height / 2.0;  // 답이 double 이여야하기 때문에 double을 섞어서 promotion 한다.
  ...
  public static void q4() {
    ...
    int[] lastDay = {0, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31}; //월과 맞추기 위해 0번째 배열값 0으로 처리
    if(month > 12 || month < 1) {
  ...
  public static void q5() {
    int a = 8;
    int b = 11;
    int diffA = (10 > a) ? 10 - a : a - 10;  // 새로운 변수를 선언하여 삼항연산 사용
    int diffB = (10 > b) ? 10 - b : b - 10;
    int answer = (diffA < diffB) ? a : b;
    System.out.println(a + ", " + b + "중 10과 가까운 수는 " + answer + "입니다.");    
    /*
     * if( 10 - a < b - 10 ) { System.out.println(a +", " + b + "중 10과 가까운 수는" + a +
     * "입니다."); } else { System.out.println(a +", " + b + "중 10과 가까운 수는" + b +
     * "입니다."); }
     */
  }
  ...
  public static void q7() {
	...
	public static void q8() {
		int number = 1234567;
		if(number / 1000000 % 2 == 1) {       // if문으로 풀이
		  System.out.println("남자입니다.");
		} else {
		  System.out.println("여자입니다.");
		}
		switch(number / 1000000) {            // switch문으로 풀이
		case 1:
		case 3:
		case 5:
		  System.out.println("남자입니다.");
	...
	// 앞 뒤로 숫자를 분리 -> 각 숫자를 더함 -> 더한 수의 제곱을 구함
	// 81 -> 8    1로 분리 ->    9  -> 9 * 9 -> 81
...
// 라벨 붙여서 break로 나가기
	...
	public static void q10() {
		...
		for(int n = begin; n <= end; n++) {
		  total += n;   // n을 total에 누적시킨다
		}
		System.out.println(begin + "부터 " + end + "사이 모든 정수의 평균은 " + (total / (end - begin + 1.0)) + "입니다."); // 소수점값을 얻기 위해 1.0(double)로 promotion
	}
	...
	public static void q14() {
		...
		String gift = "";  //  String gift = null; 문자열 연결이 필요할 땐 null을 주면 안된다.
		if(score >= 60) {
		  gift += "행주"; // gift += "행주"
		} if(score >= 70) {
		  gift += "도마";
		...
		/*
		switch(score / 10) {  // 참고용 답이 거꾸로 나온다.
		case 10:
		case 9: gift += "냄비";
		case 8: gift += "식칼";
		case 7: gift += "도마";
